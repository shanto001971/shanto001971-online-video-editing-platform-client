...
const VideoPlayer = () => {
  const videoSource =
    "https://www.youtube.com/watch?v=61floBUAiTY&list=RDGMEM916WJxafRUGgOvd6dVJkeQVM61floBUAiTY&start_radio=1";
      ...
      <div className="w-full">
            ...
            <div className="flex">
              ...
              <button className="w-10 h-8" onClick={toggleMute}>
                {isMuted ? (
                  ...
                  <BsVolumeUp className="text-white" />
                )}
              </button>
              <input
                type="range"
        ...
        <div className="bg-black rounded-b- h-40">
          <div className="   flex items-center gap-1 p-2 ">
            ...
            <img
              className="w-20 h-20"
              src="https://blog.hootsuite.com/wp-content/uploads/2020/02/Image-copyright-556x556.png"
              alt=""
            />
            <AiOutlinePlusSquare className="text-white" />
          </div>
          <div className="h-5 w-full flex px-2">
            <img
              className="h-5 w-1/2 rounded-sm"
              src="https://ak6.picdn.net/shutterstock/videos/24231536/thumb/11.jpg"
              alt=""
            />
            <AiOutlinePlusSquare className="text-white" />
            <img
