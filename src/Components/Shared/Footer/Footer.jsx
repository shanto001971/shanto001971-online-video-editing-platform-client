...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className=" footer p-4 md:p-10 bg-neutral text-neutral-content "
        style={{ rowGap: "0px" }}
      >
        <div className="flex   items-center md:items-start md:flex-col">
          <div>
            <p className="text-4xl">MotionMingle Express</p>{" "}
            <p className="w-48 mb-5 md:mb-0">
        ...
        <div className="collapse collapse-arrow md:hidden">
          <input
            ...
            style={{ marginBottom: "0px" }}
          />
          <div className="collapse-title text-xl font-medium">Create </div>
        ...
        <div className="collapse collapse-arrow md:hidden">
          <input
            ...
            style={{ marginBottom: "0px" }}
          />
          <div className="collapse-title text-xl font-medium">Resources </div>
          <div
            className="collapse-content inline-grid"
            style={{ padding: "0px" }}
          >
            <a className="link link-hover">How to add subtitles to video</a>
            <a className="link link-hover">Create makeup video</a>
