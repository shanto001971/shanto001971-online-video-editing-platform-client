...
const Footer = () => {
    ...
    return (
    <>
    <footer className="footer p-4 md:p-10 bg-neutral text-neutral-content">
  <div>
<p className='text-4xl'>MotionMingle Express</p>    <p className='w-48'>Free all-in-one video editor for everyone to create anything anywhere
</p>

      
<button className='flex items-center justify-center gap-2 rounded-md bg-slate-700 p-2'>    <TbWorld/> English <FiChevronDown className='w-[18px] '/>
</button>    
...
<div className="collapse collapse-arrow md:hidden">
  ...
  <div className="collapse-title text-xl font-medium " style={{padding:'0px'}}>
  Tools  </div>
