        ...
        {feedbackData &&
          feedbackData.map((feedback) => (
            <SwiperSlide key={feedback._id}>
              <div className={`flex flex-col items-center mt-12 lg:mx-24 mb-20 ${changesThemeTextColor()}`}>
                ...
                <div className="text-center">
                  <BiSolidQuoteAltLeft className="mt-6 mb-2 sm:mb-4 text-2xl sm:text-4xl  mx-auto" />
                  <h4 className="text-base sm:text-[19px] font-semibold">
                    {feedback.name}
                  </h4>
                  <h4 className="text-[12px] sm:text-base font-light ">
