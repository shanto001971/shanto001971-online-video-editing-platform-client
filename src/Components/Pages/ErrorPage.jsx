  ...
  return (
    <div className="error-container bg-gradient-to-r from-cyan-300 to-blue-300 h-screen flex justify-center items-center">
      <div className="error-content text-center">
        <p className="text-lg md:text-xl text-gray-800 mt-4"></p>
        ...
        <div className='max-w-md text-center'>
                    <h1 className="mb-8 font-extrabold text-3xl text-gray-600">Oops, something went wrong!      <br />     We're sorry, but an error occurred.
</h1>
