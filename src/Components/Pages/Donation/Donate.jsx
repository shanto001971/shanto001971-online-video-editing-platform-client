...
const Donate = () => {
    ...
    const handleAddToy = event => {
        ...
        const addToy = {
            Amount, email, FirstName, LastName, address, message, Cname, CNumber, cvv, expire
        }
        console.log(addToy);
    ...
    return (
        <div style={{ width: "700px", margin: "auto" }}>
            <h3 className='text-center font-bold text-3xl mb-5 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent'>Make a Donation</h3>
            <form onSubmit={handleAddToy} >
                ...
                <div className=''>
                    <div className="form-control border border-blue-400 p-4 mb-7 ">
                        ...
                        <input type="number" name='DAmount' placeholder='Enter Donation Amount' className="input input-bordered" />
                    </div>
                    <div className='border border-blue-400 p-4 mb-7'>
                        ...
                        <div className=' grid grid-cols-2 gap-4'>
                            ...
                            <div className="form-control col-span-2">
                                ...
                                <input type="text" name='message' placeholder='Message' className="input textarea textarea-primary" />
                            </div>
                        </div>
                    ...
                    <div className='border border-blue-400 p-4'>
                            ...
                            {images.map((image, index) => (
                                <img
                                    ...
                                    style={{
                                        width: "60px",
                                        height: "40px",
                                        border: `1px solid ${selected === index ? 'blue' : 'transparent'}`,
                                        padding: "5px",
                                        cursor: 'pointer',
                                    }}
                                    alt=""
                        ...
                        <div className='grid grid-cols-2 gap-2'>
                            <div className="form-control  ">
                                ...
                                <input type="text" name='Cname' className="input input-bordered" />
                            </div>
                            <div className="form-control  ">
                                <label className="label">
                                    <span className="label-text">Card Number</span>
                                </label>
                                <input type="number" name='CNumber' className="input input-bordered" />
                            </div>
                            <div className="form-control  ">
                                <label className="label">
                                    <span className="label-text">CVV</span>
                                </label>
                                <input type="number" name='cvv' className="input input-bordered" />
                            </div>
                            <div className="form-control  ">
                                <label className="label">
                                    <span className="label-text">Expire Date</span>
                                </label>
                                <input type="date" name='expire' className="input input-bordered" />
                            </div>
                        </div>
                ...
                <div className="form-control mt-6">
                    ...
                    <input className='btn btn-secondary w-60 mx-auto mb-10' type="submit" value="Donate" />
                </div>
            </form>
