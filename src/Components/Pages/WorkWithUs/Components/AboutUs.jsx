    ...
    <>
      <div className=" mb-20">
        ...
        <div
              ...
              className=" my-3 md:my-16 shadow-md shadow-gray-600 rounded-lg md:flex items-center justify-center gap-9 max-h[285px] mx-2 md:mx-20"
            >
              <div className=" ">
                  ...
                  <img
                    src={img1}
                    alt=""
                    className="object-fill rounded-md w-[350px] md:w-[505px]"
                  />
               
              </div>
              <div className="mx-4 md:mx-0 w-[350px] md:w-[505px]">
        ...
        <div
              ...
              className="my-16 shadow-md shadow-gray-600 rounded-lg md:flex flex-row-reverse items-center justify-center gap-9 max-h[285px] mx-2 md:mx-20"
            >
              <div className=" ">
              <video
loop
...
playsInline
muted
className=" rounded-md  w-[350px] md:w-[505px]"
...
></video>
            ...
            className="my-16 shadow-md shadow-gray-600 rounded-lg md:flex items-center justify-center gap-9 max-h[285px]  mx-2 md:mx-20"
          >
            <div className=" ">
