        ...
        {perks.map((perk) => (
          <div className="border-t-4 border-indigo-200 bg-white p-6 rounded-3xl rounded-tr-sm mt-5 md:mt-0  shadow-lg relative">
            <div>
              ...
              <p className="absolute -top-1 left-14 pl-8 pt-1 mt-1 rounded-tl-3xl border-indigo-200   md:text-xl font-semibold leading-none  text-indigo-900 ">
                {perk.title}
              </p>
            </div>

            <p className="pt-10 text-gray-700 font-medium">{perk.details}</p>
          </div>
        ))}
      </div>
        ...
        {perks1.map((perk) => (
          <div className="border-t-4 border-pink-200 bg-white p-6 rounded-3xl rounded-tr-sm mt-5 md:mt-0   shadow-lg relative">
            <div>
              ...
              <p className="absolute -top-1 left-7 lg:left-14 pl-8 pt-1 mt-1 rounded-tl-3xl border-indigo-200   md:text-xl font-semibold leading-none  text-indigo-900 ">
                {perk.title}
              </p>
            </div>
