    ...
    return (
        <div className={`my-12 md:my-28 rounded-xl p-8 md:p-12 ${theme.mode === "dark" ? 'text-gray-100 bg-gray-800' : "text-gray-600 bg-gray-100 "}`}>
           ...
           <div className="md:flex items-start gap-6 mt-4 text-base text-center md:text-left leading-7">
            ...
            Your training videos need not be boring. Make training more fun by creating engaging training videos that are so much more effective than traditional instructional videos. With Mingle Motions online video editing software, you can add cool music, images, and text to your videos to grab your audience’s attention.
            </div>
...
export default TrainingTextContainer;