...
import { explainerAccordionText } from "./LearnExplainerData";

const LearnExplainerFAQ = () => {
  return (
    <div className="my-20 md:my-32 md:flex items-center gap-8 lg:gap-16">
      ...
      <div className="md:w-[600px]">
        {explainerAccordionText &&
          explainerAccordionText.length > 0 &&
          explainerAccordionText.map((item) => (
...
export default LearnExplainerFAQ;
