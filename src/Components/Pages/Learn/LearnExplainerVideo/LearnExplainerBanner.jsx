...
import bannerImg from "../../../../assets/learn/Explainer/banner.png";
import { AiOutlineCloudUpload } from "react-icons/ai";

const LearnExplainerBanner = () => {
  return (
    <div className="text-center md:text-left md:flex md:w-[1/2] justify-center items-center gap-8 mt-14 mb-20 md:my-20">
      <div>
        ...
        <p className="text-base mt-4 mb-6 md:my-8">
          Transform complex ideas into animated explainer videos. Educate,
          entertain, and build credibility
        </p>
        <Link to="/dashboard">
          <button className="btn btn-sm md:btn-md text-white md:min-w-[200px] md::h-[53px] bg-black hover:bg-gray-800 group">
            <p className="text-sm md:text-base">Create an explainer video</p>
...
export default LearnExplainerBanner;
