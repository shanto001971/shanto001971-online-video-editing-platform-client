    ...
    <div className="mt-20 md:mt-32 lg:mt-52">
      <div className="text-center">
        ...
        <p className="text-sm md:text-base mb-8 leading-6">
          Mingle Motion features so much more than just video creation for
          educational purposes. You will find plenty of premium tools to create
          professional-looking videos even if you don’t have any video editing
          experience. Our user interface is incredibly beginner-friendly. All it
          takes is just a few clicks. You can create videos for special
          occasions, greeting videos, graduation videos, and so much more! You
          don’t even need to download any software; it works straight from your
          browser.
        </p>
