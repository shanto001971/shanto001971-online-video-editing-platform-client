...
const Pricing = () => {
	...
	return (
		<>
			...
			<div
				className={`text-center my-14 font-bg-blue-800 font ${
			...
			<div
				className={`md:flex items-center justify-center gap-5 my-10 mx-10 font ${
					theme.mode === 'dark' ? 'text-gray-100' : 'text-black'
				}`}
			>
			...
			<div
				className={`flex justify-between items-center mx-10 mb-10 border px-16 rounded-lg ${
					theme.mode === 'dark' ? 'text-gray-100' : 'text-black'
				}`}
			>
				<div className="font">
