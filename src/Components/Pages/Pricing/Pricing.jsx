  ...
  return (
    <>
      ...
      <div className={`text-center my-14 font-bg-blue-800 font ${theme.mode === 'dark' ? 'text-gray-100' : 'text-black'}`}>
        ...
        <h1 className="text-3xl">
          <span className="text-[#de2898]">100x cheaper</span> than buying a
          dedicated video editing computer
        </h1>
      </div>
      ...
      <div className={`md:flex items-center justify-center gap-5 my-10 mx-10 font ${theme.mode === 'dark' ? 'text-gray-100' : 'text-black'}`}>
        <div className="card w-96 shadow-lg border gradient-border duration-700">
          <div className="card-body text-center">
            ...
            <h2 className="relative">
              ...
              <span className="text-6xl">0</span> <span> / month</span>
            </h2>
            <div className="text-left">
              <p>
                <span className="text-[#ff365b]">&#10003;</span> Export 10
                minutes of videos/month
              </p>
              <p>
                <span className="text-[#ff365b]">&#10003;</span> Export 720p
                videos at super speed
              </p>
              <p>
                <span className="text-[#ff365b]">&#10003;</span> 2 GB of Cloud
                Storage
              </p>
              <p>
                <span className="text-[#ff365b]">&#10003;</span> Unlimited
                Collaborators
              </p>
              <p>
                <span className="text-[#ff365b]">&#10003;</span> Limited
                Transitions, Motions and Graphics library
              </p>
              <p>
                <span className="text-[#ff365b]">&#10003;</span> 3 day Project
                and Media back-up
              </p>
            </div>
        ...
        <div className="card w-96 shadow-lg border gradient-border2 duration-700">
          <div className="card-body text-center">
            ...
            <h2 className="relative">
              ...
              <span className="text-6xl">7</span> <span> / month</span>
            </h2>
            <div className="text-left">
              <p>
                <span>&#10003;</span> Export 10 minutes of videos/month
              </p>
              <p>
                <span>&#10003;</span> Export 720p videos at super speed
              </p>
              <p>
              ...
              <p>
                <span>&#10003;</span> Limited Transitions, Motions and Graphics
                library
              </p>
              <p>
                <span>&#10003;</span> 3 day Project and Media back-up
              </p>
            </div>
        ...
        <div className="card w-96 shadow-lg border gradient-border3 duration-700">
          <div className="card-body text-center">
            <h2 className="card-title text-[#de2898] text-2xl">Business</h2>
            <h2 className="relative">
              <span className="absolute left-20 font-semibold top-[10px] text-xl">
                $
              </span>{" "}
              <span className="text-6xl">15</span> <span> / month</span>
            </h2>
            <div className="text-left">
              <p>
                <span>&#10003;</span> Export 10 minutes of videos/month
      ...
      <div className={`flex justify-between items-center mx-10 mb-10 border px-16 rounded-lg ${theme.mode === 'dark' ? 'text-gray-100' : 'text-black'}`}>
        <div className="font">
          ...
          <p>
            For powerful integrations and advanced security, the <br />{" "}
            Enterprise plan helps you integrate the video editor with <br /> the
        ...
        <div>
          <h2 className="relative font">
            ...
            <span className="text-6xl">55</span> <span> / month</span>
          </h2>
