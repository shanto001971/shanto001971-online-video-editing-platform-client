...
const EditFeature = () => {
  ...
  return (
    <>
    <div className=" lg:py-12 bg-white px-5 md:px-20">
      {/* for mobile  */}
...
Remove video background to isolate people from the scene of a video or an image, making it more authentic and accessible.
      ...
      {/* Container Box */}
      <div className=" flex max-w-screen-xl items-center overflow-hidden bg-white lg:flex-row md:min-h-[600px]">
        {/* details container start  */}
         <div className="md:h-[800px] p-2 bg-white lg:p-11 lg:pl-10  lg:w-1/2 hidden md:block">
