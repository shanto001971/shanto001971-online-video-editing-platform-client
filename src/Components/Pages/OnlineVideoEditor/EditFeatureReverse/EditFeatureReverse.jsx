...
const EditFeaturesReverse = () => {
  ...
  return (
    ...
    >
      ...
      {/* Container Box */}
      <div className=" flex max-w-screen-xl items-center overflow-hidden lg:flex-row md:min-h-[700px]">
        ...
        <div className=" p-2 lg:p-11 lg:pl-10  lg:w-1/2 hidden md:block">
          ...
          <div className=" md:h-[450px]">
            <div className="collapse">
              ...
              >
                <p>
                  Find the right look with preset video filters and effects. You
                  can make your clips look better or match other footage in the
                  project.
                </p>
              </div>
            </div>
            ...
            <div className="collapse  ">
              ...
              >
                <p>
                  Add text to video by choosing from varied templates to retain
                  customer attention, highlight key actions, or boost brand
                  identity.
                </p>
              </div>
            </div>
            ...
            <div className="collapse ">
              ...
              >
                <p>
                  Restyle your clips with prevalent music to make the video
                  immersive and engaging. The preset audio library is at your
                  disposal.
                </p>
              </div>
            </div>
            ...
            <div className="collapse ">
              ...
              >
                <p>
                  Liven up your video with dynamic sound effects. Apply the
                  right sound effects to deliver information or engage the
                  audience.
                </p>
              </div>
            </div>
