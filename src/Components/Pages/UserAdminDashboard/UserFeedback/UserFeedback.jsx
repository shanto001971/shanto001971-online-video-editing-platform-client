          ...
          <form onSubmit={handleSubmitFeedback}>
            ...
            <div className="flex py-6">
              <div className="dropdown dropdown-hover flex-1 ">
                <label for="designation" className="p-3">
                  Designation
                </label>
              ...
              <div className="dropdown dropdown-hover ">
                <label for="ratings" className="p-3">
                  Ratings
                </label>
            ...
            <div className="form-control w-full">
              ...
              <textarea
                rows="5"
                name="message"
                className="text-[16px] leading-6 textarea textarea-bordered"
            ...
            <div className="pt-10">
              <input
                ...
                className="btn text-white w-full h-[53px] signin-button bg-black"
              ></input>
            </div>
          </form>
        </div>
