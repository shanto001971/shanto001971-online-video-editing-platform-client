      ...
      <div className="w-full h-full px-6">
          ...
          <div className="grid grid-cols-2">
            <div className="p-5">
              ...
              <p className="text-2xl text-white pt-5">
                You have completed 6 video <br /> editing this week
              </p>
              <div className="py-10">
                {" "}
                <button className="text-black bg-white px-3 py-1 rounded-lg ">
                  see all
                </button>
              </div>
            </div>
            ...
            <div className="flex">
              <div className="bg-[#BFA8FF] m-8 rounded-lg text-black p-3">
                ...
                <div>
                  <progress
                    className="progress progress-warning w-36"
                    value="70"
                    max="100"
                  ></progress>
                </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="col-span-2">
            ...
            <div className="py-5">
              <div className="bg-[#2A2B47] text-white p-2 rounded-xl">
                <div className="flex items-center justify-center py-3 text-5xl  ">
                  {" "}
                  <FaPhotoVideo></FaPhotoVideo>
                </div>

                <p className="text-center py-2">
                  Keep more editing with the Motion Mingle!
                </p>
              </div>
            </div>
          </div>
