...
const UserHome = () => {
    ...
    return (
        <div className="w-full h-full bg-[#F2F2F2] px-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="col-span-2">
          <div className="grid grid-cols-4 gap-3">
            {/* small 1 */}
            <div className="bg-[#FFFFFF] p-2 rounded-xl">
            ...
            <div >
              <div className="bg-[#FFFFFF] p-2 rounded-xl">
             <p className="text-3xl text-black font-bold">3</p>
              <small>In</small> <br />
            ...
            <div className="col-span-2 ">
             ...
             <div className="bg-[#FFFFFF] p-2 rounded-xl">
             <p className="text-3xl text-black font-bold">8.5</p>
          ...
          <div className="py-5">
          <div className="bg-[#FFFFFF] p-2 rounded-xl">
              <div className="flex items-center justify-center py-3 text-5xl text-black "> <FaPhotoVideo></FaPhotoVideo></div>
